...
<body>
  ...
  <header>
    <div class="wrap">
      <div class="flex-container">
        ...
        <span class="px14 dgray">Toko online resmi  <span class="pnl product-about">"<span class="product-name pnbd">Black Snake Super Set</span> — category"</span></span>
      </div>
    </div>
  </header>
          ...
          <div class="product-block">
            ...
            <div class="flex-container">
              ...
              <div>
                ...
                <p class="pnl px24"><span class="product-name pnbd">Black Snake Super Set</span> <br><span class="pnl px14 product-description">category</span></p>
              </div>
            </div>
      ...
      <div class="merged-blocks flex-container">
        <div class="additional-products left-block">
          <div class="flex-container">
            ...
            <p class="pnl px14 lh140"><span class="px18 pnbd">100% result guarantee</span><br>Result guarantee is valid only in case of compliance with all recommendations of specialists concerning duration and application methods of <span class="product-name">"Black Snake Super Set"</span></p>
          </div>
        </div>
        ...
        <div class="additional-products right-block">
          <div class="additional-products flex-container">
            ...
            <p class="pnl px14 lh140"><span class="px18 pnbd">Clinically proven</span><br>The efficiency and safety of "Black Snake Super Set" were proved by clinical tests  <span class="product-name">"Black Snake Super Set"</span> доказана клиническими испытаниями<br><span class="pnbd px8 upp lgray2">WCT TEST REPORT: WT-92772323432-HF-18</span></p>
          </div>
        </div>
      </div>
  ...
  <div class="block about" id="about">
    <div class="wrap">
      ...
      <p class="pnl px32 no-padding"><span class="product-name pnbd">Black Snake Super Set</span> — is manufacturer's flagship product you can trust</p>
